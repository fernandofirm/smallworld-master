...
var _jsxFileName = 'C:\\Users\\the-one\\Reactproject\\smallworld-master\\components\\FormLogin.js';
...
var FormLogin = function (_Component) {
  ...
  (0, _createClass3.default)(FormLogin, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { id: 'FormLogin', __source: {
          fileName: _jsxFileName,
          lineNumber: 40
        }
      }, _lodash2.default.isEmpty(user) ? _react2.default.createElement('div', {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 42
        }
      }, _react2.default.createElement(_reactstrap.Button, { style: { background: '#3b5998', color: 'white' }, size: 'lg', block: true, onClick: this.handleFackbook, __source: {
          fileName: _jsxFileName,
          lineNumber: 43
        }
      }, 'Facebook'), _react2.default.createElement('hr', {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 44
        }
      }), _react2.default.createElement(_reactstrap.Form, { onSubmit: this.handleLogin, __source: {
          fileName: _jsxFileName,
          lineNumber: 45
        }
      ...
      })), _react2.default.createElement(_reactstrap.Button, { color: 'primary', size: 'lg', block: true, onSubmit: this.handleLogin, __source: {
          fileName: _jsxFileName,
          lineNumber: 52
        }
      }, 'Sign In'))) : _react2.default.createElement(_reactstrap.Button, { color: 'primary', size: 'lg', block: true, onClick: this.handleLogout, __source: {
          fileName: _jsxFileName,
          lineNumber: 56
        }
      }, 'Sign Out'));
