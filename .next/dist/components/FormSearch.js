...
var _jsxFileName = 'C:\\Users\\the-one\\Reactproject\\smallworld-master\\components\\FormSearch.js';
...
var ButtonSearch = _styledComponents2.default.button(_templateObject);
...
var FormSearch = function (_Component) {
  ...
  (0, _createClass3.default)(FormSearch, [{
    ...
    value: function render() {
      ...
      var form = _react2.default.createElement(_reactstrap.Form, { onSubmit: this.handleSearch, __source: {
          fileName: _jsxFileName,
          lineNumber: 133
        }
      }, _lodash2.default.map(fullSelect, function (select) {
        return _react2.default.createElement(_reactstrap.FormGroup, { row: true, __source: {
            fileName: _jsxFileName,
            lineNumber: 141
          }
        }, _react2.default.createElement(_reactstrap.Label, { sm: 3, __source: {
            fileName: _jsxFileName,
            lineNumber: 142
          }
        }, select.label), _react2.default.createElement(_reactstrap.Col, { sm: 9, __source: {
            fileName: _jsxFileName,
            lineNumber: 143
          }
        }, _react2.default.createElement(_reactstrap.Input, { type: 'select', onChange: function onChange(e) {
          ...
          return _react2.default.createElement('option', { val: val, selected: _this2.state[select.ref] === val, __source: {
              fileName: _jsxFileName,
              lineNumber: 146
            }
          }, val);
        }))));
      }), _react2.default.createElement(_reactstrap.Button, { color: 'primary', size: 'lg', block: true, onSubmit: this.handleSearch, __source: {
          fileName: _jsxFileName,
          lineNumber: 174
        }
      }, messages['Search']));

      return _react2.default.createElement('div', { id: 'Search', __source: {
          fileName: _jsxFileName,
          lineNumber: 179
        }
      }, _react2.default.createElement(ButtonSearch, { color: 'primary', onClick: this.openModal, __source: {
          fileName: _jsxFileName,
          lineNumber: 181
        }
      }, messages['Search Nanny']), _react2.default.createElement(_reactstrap.Modal, { isOpen: this.state.modal, toggle: this.openModal, __source: {
          fileName: _jsxFileName,
          lineNumber: 183
        }
      ...
      }, messages['Search Nanny']), _react2.default.createElement(_reactstrap.ModalBody, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 185
        }
