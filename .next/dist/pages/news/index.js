...
var _jsxFileName = 'C:\\Users\\the-one\\Reactproject\\smallworld-master\\pages\\news\\index.js?entry';
//////// REDUX ///////
...
var News = function (_Component) {
  ...
  (0, _createClass3.default)(News, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_layouts2.default, { url: this.props.url, __source: {
          fileName: _jsxFileName,
          lineNumber: 48
        }
      }, _react2.default.createElement('div', { id: 'News', __source: {
          fileName: _jsxFileName,
          lineNumber: 49
        }
      }, _react2.default.createElement(_PageName2.default, { text: 'NEWS', __source: {
          fileName: _jsxFileName,
          lineNumber: 50
        }
      ...
      }, _react2.default.createElement(_reactstrap.Col, { xs: '12', md: '8', __source: {
          fileName: _jsxFileName,
          lineNumber: 58
        }
      }, _lodash2.default.map(tenNews, function (data) {
        return _react2.default.createElement(_BigThumbnail2.default, { data: data, id: data.key, __source: {
            fileName: _jsxFileName,
            lineNumber: 60
          }
        });
      ...
      }, _react2.default.createElement('div', { className: 'hidden-sm-down', style: { width: '100%', padding: '30px', background: '#b6d379', textAlign: 'center', fontSize: '60px', color: 'white' }, __source: {
          fileName: _jsxFileName,
          lineNumber: 64
        }
      ...
      }, 'S'), _react2.default.createElement('p', {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 66
        }
      }, 'M'), _react2.default.createElement('p', {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 67
        }
      }, 'A'), _react2.default.createElement('p', {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 68
        }
      }, 'L'), _react2.default.createElement('p', {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 69
        }
      ...
      }, 'W'), _react2.default.createElement('p', {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 71
        }
      }, 'O'), _react2.default.createElement('p', {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 72
        }
      }, 'R'), _react2.default.createElement('p', {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 73
        }
